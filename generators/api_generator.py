...
Cloud AI API backend for story generation.
...
class APIGenerator(StoryGenerator):
    ...
    - Google Gemini
    - OpenAI-compatible endpoints (Zhipu, etc.)
    """
    ...
    def __init__(self, config: Dict):
        ...
        Args:
            config: Dict containing:
                ...
                - endpoint: Optional[str] (for custom endpoints)
        """
        ...
        logger.info(f"API Generator initialized: {self.provider}/{self.model}")
